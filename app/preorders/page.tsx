      ...
      <div className="max-w-7xl mx-auto">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex gap-2 justify-end">
                            ...
                            <button
                              ...
                              disabled={deletingIds.has(preorder.id)}
                              className="relative text-red-600 hover:text-red-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                              title="Delete"
                            >
                              {deletingIds.has(preorder.id) ? (
                                <svg
        ...
        {toast && (
          <div className="fixed bottom-4 right-4 z-50 animate-slide-in">
            <div
              className={`rounded-lg shadow-lg p-4 min-w-80 flex items-start gap-3 ${
                toast.type === "success"
